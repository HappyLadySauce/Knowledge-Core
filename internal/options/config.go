...
var KNOWLEDGE_COREEnvBindings = map[string]string{
	...
	"redis.enabled":              "KNOWLEDGE_CORE_REDIS_ENABLED",
	"redis.required":             "KNOWLEDGE_CORE_REDIS_REQUIRED",
	"redis.url":                  "KNOWLEDGE_CORE_REDIS_URL",
	"redis.key-prefix":           "KNOWLEDGE_CORE_REDIS_KEY_PREFIX",
	"redis.pool-size":            "KNOWLEDGE_CORE_REDIS_POOL_SIZE",
	"redis.dial-timeout":         "KNOWLEDGE_CORE_REDIS_DIAL_TIMEOUT",
	"redis.read-timeout":         "KNOWLEDGE_CORE_REDIS_READ_TIMEOUT",
	"redis.write-timeout":        "KNOWLEDGE_CORE_REDIS_WRITE_TIMEOUT",
